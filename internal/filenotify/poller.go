// Adapted from github.com/gohugoio/hugo/watcher/filenotify (Apache-2.0): the sole hugo-internal
// call, herrors.IsNotExist, is replaced below with an equivalent local isNotExist helper so this
// file has no dependency outside the standard library and fsnotify.
...
// isNotExist reports whether err indicates a "file does not exist" condition,
// unwrapping err first since os.IsNotExist does not consider wrapped errors.
